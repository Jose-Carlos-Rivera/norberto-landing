...
export default function Contact() {
  return (
    <section id="contacto" className="py-16 sm:py-24 px-4 sm:px-6 lg:px-8 bg-cream">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          ...
          <div className="text-center p-6 sm:p-8 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="font-serif text-lg font-bold text-brown-dark mb-2">Teléfono</h3>
            <a
              href={`tel:${content.contact.phone.replace(/\s/g, "")}`}
              className="text-tan hover:text-tan-dark transition-colors text-sm block mb-2"
            >
          ...
          <div className="text-center p-6 sm:p-8 bg-white rounded-lg shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="font-serif text-lg font-bold text-brown-dark mb-2">Ubicación</h3>
            <p className="text-brown-light text-sm">{content.contact.address}</p>
          </div>
        </div>
      </div>
    </section>
